 ...
 */
 const insertCancel = (cancelBtn) => {
  ...
  // ajax를 이용해 전달할 데이터
  const data = {
    "commentContent" : textarea.value, // 작성한 글 내용
    "memberNo" : loginMemberNo, // 누가 작성했는지?
    "boardNo" : boardNo,  // 어느 게시글에 달린 댓글이야?
    "parentCommentNo" : parentCommentNo // 어느 댓글에 달리는 리댓이야?
  };
