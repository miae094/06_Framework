package edu.kh.project.email.model.contoller;
...
public class EmailServiceImpl implements EmailService{
	...
	// SpringTemplateEngine : 타임리프를 이용해서 htmp 코드 -> Java 코드 변환
