...
public class LoggingAspect {
	...
	public void beforeController(JoinPoint jp) {
		...
		// [MainController.mainPage] 요청 / ip : 153.168.0.27
	...
	public Object aroundServiceImpl(ProceedingJoinPoint pjp) throws Throwable {
		// Throwable - 예외처리의 최상위클래스
		// Throwable 주요 자식으로
		//			1) Exception(예외) - 개발자가 처리할 수 있는 문제
		//			2) Error(오류) - 시스템 레벨의 심각한 문제
		// proceed() 는 Throwable 이걸 던지기 때문에 Exception 으로 안됨
