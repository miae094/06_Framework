...
public class WebSocketConfig implements WebSocketConfigurer {
	...
	// Bean 으로 등록된 SessionHandshakeInterceptor 의존성 주입
	...
	public void registerWebSocketHandlers(WebSocketHandlerRegistry registry) {
		...
		// 클라이언트 연결 시 HttpSession 을 가로채
		// 핸들러에게 전달하는 handshakeInterceptor 등록
		.setAllowedOriginPatterns("http://localhost/", "http://127.0.0.1/", "http://192.168.50.237/")
		// origin : http://localhost <- 이부분
		// 127.0.0.1 : 루프백 ip
